            ...
            <div class="collapse navbar-collapse " id="navigation">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item <?php if (current_url() == base_url('Welcome/tingkat_kecemasan')) {
                        ...
                        <a class="btn btn-primary btn-round" href="<?php echo base_url('Welcome/tingkat_kecemasan'); ?>">Tingkat Kecemasan</a>
                    </li>
                    <div class="container pr-6"></div>
                    <li class="nav-item <?php if (current_url() == base_url('Welcome/diagnosa')) {
                                            echo 'active';
                                        } ?>">
                        <a class="btn btn-primary btn-round" href="<?php echo base_url('Welcome/diagnosa'); ?>">Diagnosa</a>
                    </li>
                    <div class="container pr-6"></div>
                    <li class="nav-item <?php if (current_url() == base_url('Welcome/riwayat_diagnosa')) {
                                            echo 'active';
                                        } ?>">
                        <a class="btn btn-primary btn-round" href="<?php echo base_url('Welcome/riwayat_diagnosa'); ?>">Hasil</a>
                    </li>
                </ul>
            </div>
        </div>
